...
### 1.2.2 高级特征工程
![](./img/PixPin_2025-04-28_22-06-21.jpg)
...
参考论文的模型架构，做出少量改进
##### ResNet
![](./img/PixPin_2025-04-28_22-08-57.jpg)
![](./img/PixPin_2025-04-28_22-09-10.jpg)
```python
...
##### 通道注意力机制
![](./img/PixPin_2025-04-28_18-58-42.jpg)
```python
...
##### 基于注意力的通道融合
![](./img/PixPin_2025-04-28_22-09-38.jpg)
```python
...
##### 整体结构
![](./img/PixPin_2025-04-28_22-10-04.jpg)
```python
...
平均精度分数: 0.9701
```
![](./img/roc_curve 1.png)![](./img/pr_curve 1.png)
...
### 3.2.5 最终结果
参考论文结果  
![](./img/PixPin_2025-04-28_20-02-14.jpg)  
相对最优结果  
```log
分类报告:
              precision    recall  f1-score   support
...
```
可以看出复现程度已经接近原论文
![](./img/PixPin_2025-04-28_22-10-51.jpg)
